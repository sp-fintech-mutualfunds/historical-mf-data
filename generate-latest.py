...
if __name__ == "__main__":
    # delete file latest.db
    if os.path.exists("latest.db"):
        os.remove("latest.db")
    setup_db("latest.db")
...
# echo 'CREATE INDEX "nav-main" ON "nav" ("date","scheme_code")' | sqlite3 latest.db
# echo 'CREATE INDEX "nav-scheme" ON "nav" ("scheme_code")' | sqlite3 latest.db
# echo 'CREATE INDEX "securities-scheme" ON "securities" ("scheme_code")' | sqlite3 latest.db
# echo 'CREATE INDEX "securities-isin" ON "securities" ("isin")' | sqlite3 latest.db